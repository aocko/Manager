...
public class ClassDao {
    public List<Class> getclassList(Connection connection) throws SQLException {
    ...
    public List<Class> getclassList(Connection connection, String className, String classStatus) throws SQLException {
        List<Class> classList = new ArrayList<>();
        ...
        if (StringUtil.isNotEmpty(classStatus)) {
